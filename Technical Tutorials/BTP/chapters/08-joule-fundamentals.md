...
**Example 1: HR Manager in SuccessFactors**
```
...
**Example 2: Procurement in Ariba**
```
...
graph TB
    subgraph "SKILL"
        S[Single Action]
        S --> |"Example"| SE["GetOrderStatus(12345)"]
    end

    subgraph "AGENT"
        A[Multiple Skills + Reasoning]
        A --> |"Example"| AE["Handle entire complaint process"]
    end
...
| **Example** | "Get order status" | "Handle customer complaint" |
...
This connects back to Chapter 5. Here's why you cannot skip destinations:
...
## 8.5 Real-World Skill Examples

### Example 1: Sales Order Status Lookup
...
### Example 2: Create Purchase Requisition
...
### Example 3: External Weather API for Logistics
...
*[Previous: Chapter 7 – Fiori & UI5 in BTP](07-fiori-ui5-btp.md) | [Next: Chapter 9 – Building Your First Joule Skill](09-first-joule-skill.md)*
