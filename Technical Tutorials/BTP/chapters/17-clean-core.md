...
### Example: Finding Sales Order API
...
## 17.6 Practical Migration Examples

### Example 1: Z-Report → Fiori App
...
### Example 2: User Exit → Released BADI
...
### Example 3: Direct Table → Released API
...
*[Previous: Chapter 16 – Cloud Connector](16-cloud-connector.md) | [Next: Appendix A – Quick Reference Tables](appendix-a-reference-tables.md)*
