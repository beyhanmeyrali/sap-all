# Kısım 11: Agent Lifecycle & Deployment
...
**CI/CD Pipeline Örnek (Azure DevOps):**
```yaml
trigger:
  branches:
    include:
...
*[Önceki: Kısım 10 – Building Joule Agents](10-building-agents.md) | [Sonraki: Kısım 12 – Managing Multiple Clients](12-multi-client-management.md)*
